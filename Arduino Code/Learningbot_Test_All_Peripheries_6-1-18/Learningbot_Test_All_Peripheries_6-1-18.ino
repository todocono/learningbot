...
void testAnalogInput() {
  /*
     ...
     neopixel near it.
  */
  int analog1 = analogRead(Sensor1AnaloglPin) / 4;
  int analog2 = analogRead(Sensor2AnaloglPin) / 4;
  int analog3 = analogRead(Sensor3AnaloglPin) / 4;
  int analog4 = analogRead(Sensor4AnaloglPin) / 4;
